...
<div class="armacaoCategoriaGames">
    <div class="leftCategoriaGames">
        ...
        $cmd = "SELECT * FROM tn_posts WHERE categoria = 1  AND status = 1";
        ...
        $cmd = "SELECT * FROM tn_posts WHERE categoria = 1  AND status = 1 ORDER BY data DESC limit $inicio,$registros";
        $tn_posts = mysql_query($cmd);
        $total = mysql_num_rows($tn_posts);
